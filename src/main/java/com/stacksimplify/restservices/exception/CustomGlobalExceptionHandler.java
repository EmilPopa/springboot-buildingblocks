...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	// MethodArgumentNotValidException --suprascriu aceasta metoda care se afla in	// ResponseEntityExceptionHandler
...
//ex: incerc sa creez user cu patch 
		CustomErrorDetails customErrorDetails = new CustomErrorDetails(new Date(),
				"From HttpRequestMethodNotSupportedException in GlobalExceptionHandler- Method not allowed", ex.getMessage());
